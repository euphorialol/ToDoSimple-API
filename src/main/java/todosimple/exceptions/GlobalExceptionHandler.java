...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler implements AuthenticationFailureHandler {
    ...
    //Validação de entidades, retorna erro 422
    ...
    //Retorna um erro padrão( erro 500) para exceptions que o programador ainda não tratou
    ...
    //Tratamento de erros de conflito. Ex: criar um usuário com um username que ja existe, retorna um erro 409
    ...
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    //Ex: tentar criar um usuário sem passar alguma das entidades obrigatórias, retorna erro 422
